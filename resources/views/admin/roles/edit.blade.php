...
<section class="section">
    <div class="section-body">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <x-cardheader title="Edit Role" /> 
              <x-form action="{{ route('roles.update', $role->id) }}" method="patch"> 
                <div class="card-body">
                        ...
                        <td>
                            <div class="pretty p-icon p-jelly p-round p-bigger">
                              <?php
                                  ...
                                  ?>
                              @if($hasPermission)
                              {{ Form::checkbox("permission[{$permissionName}]", "{$permissionName}", $role->hasPermissionTo($permissionName)) }}
