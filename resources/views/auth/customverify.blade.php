        ...
        <div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
            ...
            <div class="p-t-50 p-b-60">
                <p class="m1-txt1 p-b-36">
                    <span class="m1-txt2">Verification to DashCE</span>
                </p>
                ...
                <form class="contact100-form validate-form" method="POST" action="{{ route('verify-otp.store') }}">
                   @csrf
                   ...
                   <div class="wrap-input100 m-b-20 validate-input" data-validate ="Otp is required">
                        <input class="s2-txt1 placeholder0 input100" type="number" name="otp" id="otp" placeholder="Otp">
                        <span class="focus-input100"></span>
                    </div>
