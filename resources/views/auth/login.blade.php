...
<body>
    ...
    <div class="size1 bg0 where1-parent">
        ...
        <div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
            <div class="wrap-pic1">
                <span class="m1-txt2">{{ucfirst(basename(base_path()))}}</span>
                <!-- <img src="images/icons/logo.png" alt="LOGO"> -->
            </div>

            <div class="p-t-50 p-b-60">
                <p class="m1-txt1 p-b-36">
                    <span class="m1-txt2">Welcome to {{ucfirst(basename(base_path()))}}</span>
                </p>
                ...
                <div class="w-full">
                    <a class="flex-c-m s2-txt2 size4 bg1 bor1 hov1 trans-04" href="{{ route('register') }}">Register</a>
                </div>
            </div>
